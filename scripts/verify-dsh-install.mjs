...
const ENVS = [
  ...
  'DSH_COMPAT_ROOT',
  'DSH_USERS_PLATFORM_COMPAT_ROOT',
  'DSH_USERS_PLATFORM_DSH_BIN',
  'PI_AI_DATA_DIR',
  'DSH_USERS_PLATFORM_PI_AI_DATA_DIR',
]
const clearEnv = () => {
...
for (const k of ['DSH_PACKAGE_DIR', 'DSH_USERS_PLATFORM_PACKAGE_DIR', 'DSH_COMPAT_ROOT', 'DSH_USERS_PLATFORM_COMPAT_ROOT']) {
  clearEnv()
...
for (const k of ['DSH_USERS_PLATFORM_DSH_BIN']) {
  clearEnv()
...
process.env.DSH_USERS_PLATFORM_DSH_BIN = otherBin
...
for (const k of ['PI_AI_DATA_DIR', 'DSH_USERS_PLATFORM_PI_AI_DATA_DIR']) {
  clearEnv()
  process.env.DSH_PACKAGE_DIR = '/opt/whatever/dsh'
