 ...
 *
 * 用法：
 *   node scripts/migrate-sqlite-to-pg.mjs --sqlite /var/lib/dsh-users-platform/dsh-users-platform.db \
 *        --pg postgres://dsh-users-platform:***@127.0.0.1:<PG_PORT>/dsh-users-platform [--dry-run]
 *
 * @module dsh-users-platform/scripts/migrate-sqlite-to-pg
 */
