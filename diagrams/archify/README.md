...
Ten self-contained HTML diagrams describing this platform — five subjects, each in English and Chinese. Every one is a single file with no external requests: open it in a browser and it works offline, including theme switching, pan and zoom, search, focus, and PNG/SVG/JPEG export.
